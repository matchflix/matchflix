...
class Movies extends Component {
  ...
  componentDidMount() {
    ...
    fetch(currentUrl)
      ...
      .then((moviesArray) => {
        ...
        // use dummy testMoviesArray for now
        this.setState({movies: testMoviesArray})
  ...
  handleVote(movieIndex, movieIsLiked) {
    // update state.votes so that the element at movieIndex is movieIsLiked
    // console.log('handleVote was called with' + movieIndex + movieIsLiked);
